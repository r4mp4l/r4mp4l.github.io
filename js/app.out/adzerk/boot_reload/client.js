...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__6915,opts){
var map__6916 = p__6915;
...
var files = cljs.core.get.call(null,map__6916__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6044__auto___6922 = arguments.length;
var i__6045__auto___6923 = (0);
while(true){
if((i__6045__auto___6923 < len__6044__auto___6922)){
args__6051__auto__.push((arguments[i__6045__auto___6923]));

var G__6924 = (i__6045__auto___6923 + (1));
i__6045__auto___6923 = G__6924;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6920){
var vec__6921 = p__6920;
var opts = cljs.core.nth.call(null,vec__6921,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6921,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6921,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6921,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6921,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6918){
var G__6919 = cljs.core.first.call(null,seq6918);
var seq6918__$1 = cljs.core.next.call(null,seq6918);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6919,seq6918__$1);
});
